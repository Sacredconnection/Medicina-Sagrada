...
export function ProductCard({ product }: { product: WooProduct }) {
  ...
  return (
    <article className="product-card">
      <Link className="product-card-image-link" href={`/product/${product.slug}/`} tabIndex={-1} aria-hidden="true">
      ...
      <div className="product-card-body">
        <div className="product-card-meta">
          ...
          <span className="product-rating" aria-label={`${product.average_rating} de 5 estrelas`}>
